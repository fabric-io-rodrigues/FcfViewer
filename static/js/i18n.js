...
const TRANSLATIONS = {
  ...
  pt: {
    ...
    /* Upload */
    'up.title':      'Carregar arquivo FCF',
    'up.select_btn': 'Selecionar arquivo',
    'up.drop':       'Arraste o arquivo aqui ou clique para selecionar',
    'up.hint':       'costmexx.psr  ·  costmexx.xls  ·  costmexx.csv',
    'up.url_or':     'ou via URL',
    'up.url_lbl':    'ou endereço:',
    'up.url_ph':     'https://example.com/costmexx.psr',
    'up.btn':        'Carregar',
    'up.samples_or': 'ou carregar um exemplo',
  ...
  es: {
    ...
    'up.title':      'Cargar archivo FCF',
    'up.select_btn': 'Seleccionar archivo',
    ...
    'up.url_ph':     'https://example.com/costmexx.psr',
    'up.btn':        'Cargar',
    'up.samples_or': 'o cargar un ejemplo',
  ...
  en: {
    ...
    'up.title':      'Load FCF file',
    'up.select_btn': 'Select file',
    'up.drop':       'Drag and drop or click to select',
    'up.hint':       'costmexx.psr  ·  costmexx.xls  ·  costmexx.csv',
    'up.url_or':     'or via URL',
    'up.url_lbl':    'or address:',
    'up.url_ph':     'https://example.com/costmexx.psr',
    'up.btn':        'Load',
    'up.samples_or': 'or load an example',
